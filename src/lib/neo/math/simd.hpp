...
#if defined(NEO_HAS_SIMD_SSE2)
using icomplex64x2  = interleaved_complex<float32x4>;
using icomplex128x1 = interleaved_complex<float64x2>;
using pcomplex64x4  = parallel_complex<float32x4>;
using pcomplex128x2 = parallel_complex<float64x2>;
#endif

#if defined(NEO_HAS_SIMD_AVX)
using icomplex64x4  = interleaved_complex<float32x8>;
using icomplex128x2 = interleaved_complex<float64x4>;
using pcomplex64x8  = parallel_complex<float32x8>;
using pcomplex128x4 = parallel_complex<float64x4>;
#endif

#if defined(NEO_HAS_SIMD_AVX512F)
using icomplex64x8  = interleaved_complex<float32x16>;
using icomplex128x4 = interleaved_complex<float64x8>;
