...
template<std::floating_point Float>
auto upols_convolver<Float>::filter(KokkosEx::mdspan<std::complex<Float> const, Kokkos::dextents<size_t, 2>> filter)
    -> void
{
...
template<std::floating_point Float>
auto upols_convolver<Float>::operator()(std::span<Float> block) -> void
{
